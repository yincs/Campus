...
public class AnnotationHandlerMethodExceptionResolver extends ExceptionHandlerExceptionResolver {
	...
	// @SuppressWarnings({ "unchecked", "rawtypes" })
	// private ModelAndView handleResponseError(ServiceResponse returnValue,
	...
	// }
	// if (logger.isWarnEnabled()) {
	// logger.warn("Could not find HttpMessageConverter that supports return
	// type [" + returnValueType + "] and "
	// + acceptedMediaTypes);
	// }
	// return null;
	// }
